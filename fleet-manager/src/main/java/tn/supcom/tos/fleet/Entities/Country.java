...
import tn.supcom.tos.fleet.Entities.adapters.CountryAdapter;

import java.util.*;
import java.util.stream.Collectors;

@JsonbTypeAdapter(CountryAdapter.class)
...
public enum Country {
    ...
    public Continent getContinent(){
        return Continent.countryContinentMap.get(this);
    }

    public String getContinentName(Locale locale){
        return Continent.countryContinentMap.get(this).getName(locale);
    }

    public String getContinentRegion(Locale locale){
        return Continent.countryContinentMap.get(this).getRegion(this,locale);
    }
